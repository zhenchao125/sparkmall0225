package com.atguigu.sparkmall0225.mock


import java.text.SimpleDateFormat
import java.util.UUID

import com.atguigu.sparkmall0225.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.sparkmall0225.common.util.ConfigurationUtil
import com.atguigu.sparkmall0225.mock.util.{RandomDate, RandomNumUtil, RandomOptions}
...
object MockOffline {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val userVisitActionDF: DataFrame = sc.makeRDD(userVisitActionData).toDF
